# Generated by Django 5.0.3 on 2024-07-14 19:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sitemodule', '0009_alter_slider_image'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('product_list', 'صفحه لیست محصولات'), ('product_detail', 'ٌصفحه ی جزییات محصولات'), ('about_us', 'درباره ما')], max_length=200, verbose_name='جایگاه نمایشی')),
            ],
            options={
