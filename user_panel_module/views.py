...
class EditUserProfilePage(View):
    def get(self, request: HttpRequest):
        ...
        edit_form = EditProfileModelForm(instance=current_user)  # initial={
...
def user_basket(request: HttpRequest):
    user_open_order, created = Order.objects.prefetch_related('orderdetail_set').get_or_create(is_paid=False,
                                                                                               user_id=request.user.id)
    total_amount = user_open_order.calculate_total_price
