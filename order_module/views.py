...
MERCHANT = "d24d0902-bc54-4627-b2af-f9da34eb2090"
    ...
    if request.user.is_authenticated:
        ...
        if product is not None:
            ...
            return JsonResponse({
                ...
                'confirm_button_text': 'یاشه ممنونم',
                'icon': "success"
            })
        else:
            return JsonResponse({
    ...
    if request.GET.get('Status') == 'OK':
        ...
        if len(req.json()['errors']) == 0:
            ...
            if t_status == 100:
                ...
                return render(request, 'order_module/payment_ result.html', {
